...
var TableHeaderContent = function TableHeaderContent(_ref) {
  var display = _ref.display,
      ...
      customProps = _objectWithoutProperties(_ref, ['display', 'height', 'minWidth', 'sort', 'onClick']);
  ...
  var ascSortInd = (0, _classnames2.default)([_defineProperty({}, 'terra-Table-sort-indicator', sort === 'asc'), { 'terra-Table-hidden': sort !== 'asc' }]);

  var descSortInd = (0, _classnames2.default)([_defineProperty({}, 'terra-Table-sort-indicator', sort === 'desc'), { 'terra-Table-hidden': sort !== 'desc' }]);

  return _react2.default.createElement(
    'th',
    _extends({ scope: 'col', onClick: onClick, className: contentClassName }, customProps),
